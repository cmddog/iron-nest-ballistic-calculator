...
const elevationDisplay = createTween(
  ...
  {
    duration: 1000,
    ease: cubicBezier(0.1, 0.8, 0.4, 1),
...
// --------------------------
// This parts's generated by Claude Sonnet. I did not feel like learning how cubic bezier curves work just to make
// the numbers look a little nicer
